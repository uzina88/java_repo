...
public class variableEx {
	...
	public static void main(String[] args) {
		...
		System.out.println("숫자 변수 3: [ " + varNumResult + " ] 입니다.");
		
		System.out.println("숫자 1과 숫자2를 더하면? [ " + (varNum + varNumber) + " ] 입니다.");
		*/
		...
		*/
		...
		ageResult = ageResult + varNum; // 38
		
		int ageResult2 = ageResult; // 다른 변수에 저장해서 가능
		
		System.out.println(" 다다다음해는 [ " + yearResult + " ] 년도 입니다." );
		System.out.println(" 다다다음해 내 나이는 [ " + ageResult + " ] 세 입니다." );
		System.out.println(" 다다다음해 내 나이는 [ " + ageResult2 + " ] 세 입니다." );  // 다른 변수에 저장해서 가능
